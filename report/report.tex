...
The other alternatives gives us similar results that do not change our considerations. Full details can be found in the \hyperref[s:appendix]{Appendix}. The only exception is alternative $3$ \textbf{todo complete}.
