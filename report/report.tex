...
The other alternatives gives us similar results that do not change our considerations. Full details can be found in the \hyperref[s:appendix]{Appendix}. The only exception is alternative $3$ because the score obtained by each player is not equally distributed as in the other two cases. This benefit the strategies that obtain the best overall score and disadvantage all the other strategies.
