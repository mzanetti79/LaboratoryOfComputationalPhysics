...
More insights about this part, including the complete collection of the generated pictures, can be found in the repository and in both \autoref{tab:ipd2p} and \autoref{tab:ipd2pavg}, where collected statistics are presented. \textbf{should we ref another time the tables? they are both ref'ed above}
...
\textbf{Mi sembra un po' slegata ->, FR: togliendo that was prima di proposed va meglio?} The winner over all the strategies analyzed by Axelrod in his extensive tests, thoroughly described in \cite{axelrod1981evolution,axelrod1984evolution} and taken up as a starting point in \cite{mathieu2017}, was the simple \textit{TfT} proposed by Anatol Rapoport.
...
Note that \textit{GrT} is not available if the strategy is going to change towards the good side, a choice dictated by the behavior of the trigger strategy.
